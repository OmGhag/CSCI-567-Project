...
def train_model(X_train, t_train, max_depth = 10, min_samples_leaf = 10, criterion = 'gini', 
  ...
  #Random Forest: TODO (call RandomForestClassifier with appropriate parameters)
    ...
    model = RandomForestClassifier(max_depth=max_depth, min_samples_leaf=min_samples_leaf, criterion=criterion, random_state=seed, n_estimators=n_estimators, max_samples=max_samples, max_features=max_features)
